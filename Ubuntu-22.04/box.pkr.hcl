...
variable "mirror" {
  type    = string
  default = "https://www.releases.ubuntu.com"
}
...
locals {
  ...
  iso_url           = "${var.mirror}/${local.version_major}.${local.version_minor}/ubuntu-${local.version_major}.${local.version_minor}.${local.version_patch}-live-server-amd64.iso"
}
